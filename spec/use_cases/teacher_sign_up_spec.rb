...
describe Tyto::TeacherSignUp do
  ...
  it "creates a teacher with valid information" do
    result = subject.run( username: "New Guy",
                          password: "as8asd!asd",
                          password_confirmation: "as8asd!asd",
    ...
    expect(result.teacher).to be_a Tyto::Teacher
    expect(result.teacher.username).to eq "New Guy"
  end
